...
const createAssistant = async (axiosInstance) => {
  ...
  if (fs.existsSync(assistantFilePath)) {
    ...
    // Asegurarse de incluir el encabezado 'OpenAI-Beta' en la solicitud de archivos
    ...
    // Asegurarse de incluir el encabezado 'OpenAI-Beta' en la solicitud del asistente
